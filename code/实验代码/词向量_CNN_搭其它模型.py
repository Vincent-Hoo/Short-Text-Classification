...
import pandas as pd
import numpy as np
from keras.layers import Input, Embedding, Conv1D, GlobalMaxPooling1D, Activation, Dense, concatenate, merge, Lambda
...
word2vec_model = KeyedVectors.load_word2vec_format('../../data/news_data/model/word2vec_dim10_format')
...
for i in range(d):
    ...
    conv = Conv1D(1, height, padding = 'same')(merged)
