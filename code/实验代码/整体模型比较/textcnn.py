...
import pandas as pd
import numpy as np
from keras.layers import Input, Embedding, Conv1D, GlobalMaxPooling1D, Activation, Dense, concatenate, Lambda
...
for i in range(100):
    ...
    conv = Conv1D(1, height, padding = 'same')(word_embedding)
